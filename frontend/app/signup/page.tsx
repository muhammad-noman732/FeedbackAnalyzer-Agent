...
export default function SignupCardSection() {
  ...
  const { register, handleSubmit, errors, onSubmit, isLoading, error } = useSignupForm();
  ...
  return (
    <section className="min-h-screen bg-black text-zinc-50 overflow-y-auto overflow-x-hidden relative flex flex-col pt-24 pb-12">
      ...
      <div className="flex-1 w-full flex items-center justify-center px-4 relative z-10">
        <Card className="card-animate w-full max-w-md border-white/10 bg-zinc-900/40 backdrop-blur-md supports-[backdrop-filter]:bg-zinc-900/30 my-auto">
          ...
          <CardFooter className="flex items-center justify-center text-sm text-zinc-400">
            ...
            <Link className="ml-1 text-white hover:underline" href="/login">
              Sign in
            </Link>
          </CardFooter>
        </Card>
